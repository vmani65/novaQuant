...
public class TradeLegConfig {
    ...
    public TradeLegConfig(String positionSide, String optionType, String actionType, int lots, String strike) {
	...
	public String toString() {
		return "TradeLegConfig [positionSide=" + positionSide + ", optionType=" + optionType + ", actionType="
