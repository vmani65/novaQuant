 ...
 *
 * Fields use BUY/SELL prefix (matching boughtPrice/soldPrice and buyIntendedPrice/
 ...
 */
@Entity
@Table(name = "WEEKLY_ORDER_FILL",
       uniqueConstraints = @UniqueConstraint(name = "uk_weekly_order_fill_slice",
                                              columnNames = {"weekly_order_book_id", "SLICE_INDEX"}))
@Getter
@Setter
public class WeeklyOrderFill extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "weekly_order_book_id", nullable = false)
    private WeeklyOrderBook weeklyOrderBook;
